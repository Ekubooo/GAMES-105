...
def Full_Body_FK(meta_data, joint_positions, joint_orientations, local_rot_overrides=None, locked_path=None):
    locked = set(locked_path) if locked_path is not None else set()
    local_rot = {}
