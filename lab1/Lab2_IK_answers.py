...
def part1_inverse_kinematics(meta_data, joint_positions, joint_orientations, target_pose):
    ...
    return part1_ik.solve_ccd(meta_data, joint_positions, joint_orientations, target_pose)
    # return part1_ik.solve_autograd(meta_data, joint_positions, joint_orientations, target_pose)
    # return part1_ik.solve_gauss_newton(meta_data, joint_positions, joint_orientations, target_pose)
...
def part2_inverse_kinematics(meta_data:MetaData, joint_positions, joint_orientations, relative_x, relative_z, target_height):
    ...
    """
    root_Index = meta_data.joint_name.index(meta_data.root_joint)
    root_Pos = joint_positions[root_Index]
    end_Pos = [root_Pos[0] + relative_x, target_height, root_Pos[2] + relative_z]

    # joint_positions, joint_orientations = part1_inverse_kinematics(meta_data, joint_positions, joint_orientations, end_Pos)
    joint_positions, joint_orientations = part1_IK_Origin(meta_data, joint_positions, joint_orientations, end_Pos)
